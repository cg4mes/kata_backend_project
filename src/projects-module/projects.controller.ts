...
export class ProjectsController {
	...
	@ApiResponse({ status: 401, description: 'Token JWT inválido o expirado' })
	partialUpdate(@Param('id') id: string, @Body() updateProjectDto: UpdateProjectDto): Promise<any> {
	...
	@ApiResponse({
		status: 200,
		description: 'Proyecto eliminado exitosamente junto con todas sus ejecuciones',
	})
	@ApiResponse({
		status: 404,
		description: 'Proyecto no encontrado con el ID proporcionado',
