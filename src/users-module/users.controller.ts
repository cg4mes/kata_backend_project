...
export class UsersController {
	...
	@ApiResponse({
		status: 201,
		description: 'Usuario registrado exitosamente. Retorna los datos del usuario (sin contraseña)',
	...
	@ApiResponse({
		status: 400,
		description: 'Datos de entrada inválidos (email incorrecto, contraseña muy corta, etc.)',
	})
	...
	@ApiResponse({
		status: 200,
		description: 'Lista de usuarios (sin contraseñas). Incluye ID, username, email, rol y fechas',
		type: [UserResponseDto],
	})
	@ApiResponse({
		status: 403,
	...
	@ApiResponse({
		status: 200,
		description: 'Rol actualizado exitosamente. Retorna los datos actualizados del usuario',
		type: UserResponseDto,
	})
	@ApiResponse({
		status: 404,
